  ...
  render() {
    return (
      ...
      <div className="members">
        <Navbar></Navbar>
        <Title center>members screen</Title> {/* see, here we just use the Title component we imported. You may notice we pass 'center' and we also pass 'The home screen' between the tags, I'll explain in the Title component file */}
